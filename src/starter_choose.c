...
#define STARTER_ONE (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_ARON)
#define STARTER_TWO  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_LAIRON)
#define STARTER_THREE (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_AGGRON )
