...
#define STARTER_ONE (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_HORSEA)
#define STARTER_TWO  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_GASTLY)
#define STARTER_THREE (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_ARON)
