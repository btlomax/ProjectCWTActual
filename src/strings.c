...
const u8 gText_BirchInTrouble[] = _("These POKé BALLS aren't yours...\nBut fate draws your hand closer...");
const u8 gText_ConfirmStarterChoice[] = _("You feel a strong bond with this one.\nTake it?");
